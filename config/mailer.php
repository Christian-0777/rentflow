...
// SendGrid Configuration (not used – SMTP is primary)
...
/**
 * Send an email using PHPMailer via SMTP (SendGrid disabled)
 *
...
function send_mail($to, $subject, $body) {
    // Always use PHPMailer with SMTP; ignore SendGrid
    // (SendGrid-related configuration and methods remain for reference but are not used.)
    return send_mail_phpmailer($to, $subject, $body);
}

/**
 * Send an email using SendGrid API (unused)
 *
 * This function is retained for reference but not called by send_mail.
 *
 * @param string $to Recipient email address
 * @param string $subject Email subject
 * @param string $body HTML body content
