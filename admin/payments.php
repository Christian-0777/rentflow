    ...
    try {
        ...
        if ($tenant) {
            ...
            if ($action_type === 'paid') {
                ...
                $message = "Your payment of ₱" . number_format($due_record['amount_due'],2) . " has been marked as paid. Thank you!";
            } elseif ($action_type === 'partial') {
                $amount_paid = (float)($_POST['amount_paid'] ?? 0);
                $remaining = $due_record['amount_due'] - $amount_paid;
                $title = 'Partial Payment Recorded';
                $message = "A partial payment of ₱" . number_format($amount_paid,2) . " was received. Remaining ₱" . number_format($remaining,2) . " has been added to your arrears.";
            } elseif ($action_type === 'notpaid') {
                $title = 'Payment Updated';
                $message = "Your due amount of ₱" . number_format($due_record['amount_due'],2) . " has been marked as not paid and added to your arrears.";
            }
