...
- **User Management**: Users with different roles (tenant, admin)
...
| role | ENUM('tenant','admin') | NOT NULL | User role in the system |
...
| due_id | INT(11) | NULL, FOREIGN KEY | Reference to the due record this payment (or mark-not-paid) relates to |
...
## 13. AUTH_CODES TABLE
**Purpose**: Store authentication codes for admin access

| Column | Type | Constraints | Description |
|--------|------|-------------|-------------|
| id | INT(11) | PRIMARY KEY, AUTO_INCREMENT | Code set unique identifier |
| role | ENUM('admin') | NOT NULL | Role these codes are for |
...
- **auth_codes**: Admin authentication
